...
public class RegistryEntry implements Serializable {
  ...
  /**
   * Returns value type as Inno Setup expects https://jrsoftware.org/ishelp/index.php?topic=registrysection
   */
  ...
  public String toString() {
    return "RegistryEntry [key=" + key + ", valueName=" + valueName + ", valueType=" + valueType
        + ", valueData="
        + valueData + "]";
  }
