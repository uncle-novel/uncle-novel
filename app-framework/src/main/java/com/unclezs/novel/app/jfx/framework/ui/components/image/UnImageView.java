package com.unclezs.novel.app.jfx.framework.ui.components.image;
...
public class UnImageView extends ImageView {
  ...
  public DoubleProperty fitToWidthProperty() {
    if (this.fitWidth == null) {
      this.fitWidth = new SimpleStyleableDoubleProperty(StyleableProperties.FIT_WIDTH, this,
          "-fx-fit-width") {
        @Override
  ...
  public DoubleProperty fitToHeightProperty() {
    if (this.fitHeight == null) {
      this.fitHeight = new SimpleStyleableDoubleProperty(StyleableProperties.FIT_WIDTH, this,
          "-fx-fit-height") {
        @Override
        protected void invalidated() {
