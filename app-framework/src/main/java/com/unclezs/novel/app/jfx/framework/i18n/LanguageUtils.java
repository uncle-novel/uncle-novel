...
import com.unclezs.novel.app.jfx.framework.i18n.bundle.XmlResourceBundle;
import com.unclezs.novel.app.jfx.framework.i18n.control.XmlControl;
...
public class LanguageUtils {
  ...
  public static XmlResourceBundle getResourceBundle(String bundleName) {
    return (XmlResourceBundle) ResourceBundle
        .getBundle(bundleName, Locale.getDefault(), XmlControl.ME);
  }
