package com.unclezs.novel.app.framework.factory;
...
public class ViewFactory {
  ...
  private static final ViewFactory CONTEXT = new ViewFactory();
  ...
  public <V> V getView(Class<?> clazz) {
