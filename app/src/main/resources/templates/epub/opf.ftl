...
<package xmlns="http://www.idpf.org/2007/opf" version="2.0" unique-identifier="FoxUUID">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    ...
    <dc:identifier opf:scheme="uuid" id="FoxUUID">79825d33-641e-4235-8e1b-596c7d57c94a
    </dc:identifier>
  ...
  <manifest>
    ...
    <#list article.chapters as chapter>
      <item id="chapter_${chapter_index}" media-type="application/xhtml+xml"
            href="html/${chapter_index}.html"/>
    </#list>
  </manifest>
