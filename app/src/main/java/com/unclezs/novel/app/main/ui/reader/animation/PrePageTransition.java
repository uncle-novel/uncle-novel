package com.unclezs.novel.app.main.ui.reader.animation;
 ...
 * @date 2021/5/8 16:49
 */
public class PrePageTransition extends Transition {
  ...
  public PrePageTransition(Region node, Region container) {
  ...
  protected void interpolate(double d) {
    timeline.getKeyFrames().set(0, new KeyFrame(Duration.ZERO,
      new KeyValue(node.translateXProperty(), -container.getWidth(), Interpolator.EASE_BOTH)
    ));
