...
public class LeftNavigationViewSkin extends SkinBase<LeftNavigation> {
    ...
    protected void layoutChildren(double contentX, double contentY, double width, double height) {
        ...
        for (LeftNavigationMenuItem actionItem : actionItems) {
        ...
        for (Iterator<LeftNavigationMenuItem> var22 = managedActionItems.iterator(); var22.hasNext(); currentX += actualNodeWidth) {
            LeftNavigationMenuItem button = var22.next();
