...
public class TestStage extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        theme1.setOnMouseClicked(e->{
            com.uncles.novel.app.jfx.framework.app.Application.setUserAgentStylesheet(STYLESHEET_MODENA);
        });
        theme2.setOnMouseClicked(e->{
            com.uncles.novel.app.jfx.framework.app.Application.setUserAgentStylesheet(STYLESHEET_CASPIAN);
        });
