  ...
  public static String execute(File workingDirectory, String executable, Object... arguments)
    ...
    if (result.getExitCode() != 0) {
      throw new CommandLineException(
          "Command execution failed: " + executable + " " + StringUtils.join(arguments, " "));
    }
    return result.getOutput();
  }

  public static String execute(String executable, Object... arguments)
      throws IOException, CommandLineException {
    return execute(new File("."), executable, arguments);
  }

  public static ExecutionResult executeWithResult(File workingDirectory, String executable,
      Object... arguments) throws IOException, CommandLineException {
